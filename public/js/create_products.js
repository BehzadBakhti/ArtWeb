$(document).ready(function() {
    ...
    $(add_button).click(function(e) {
        ...
        $(wrapper).append('<label class="image-container"><button type="button" class= "x text-center"> x </button> <label> <a class="image_link" id="image_link_'+x+'" href="#"  > <img id="btn_image_'+x+'" src="{{asset("/images/default.png")}}" width="100px" height="100px" > </a> <input type="file" name="images[]" class="my_file" id="my_file_'+x+'" style="display: none;" /> </label>    </label>');
        }
    });
